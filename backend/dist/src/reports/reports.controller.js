...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get main HRMS dashboard metrics & statistics' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Export HRMS reports to CSV' }),
    (0, swagger_1.ApiQuery)({ name: 'type', enum: ['EMPLOYEE', 'ATTENDANCE', 'LEAVE', 'PAYROLL'] }),
