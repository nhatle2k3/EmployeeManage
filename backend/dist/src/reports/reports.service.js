...
let ReportsService = class ReportsService {
    ...
    async getDashboardSummary() {
        ...
        const [totalEmployees, activeEmployees, departmentsCount, employeesByDept, todayAttendance, pendingLeaves, pendingOvertime, latestPayrollPeriod,] = await Promise.all([
